...
import org.apache.activemq.store.kahadb.disk.index.BTreeNode.Marshaller;
...
public class XMLConvert<T> {
	...
	public String object2XML(T obj) throws Exception {
		JAXBContext ctx = JAXBContext.newInstance(type.getClass());
		Marshaller ms = (Marshaller) ctx.createMarshaller();
		StringWriter sw = new StringWriter();
		((javax.xml.bind.Marshaller) ms).marshal(obj, sw);
		return sw.toString();
	}
}